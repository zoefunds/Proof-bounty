...
|---|---|---|
| `NEXT_PUBLIC_PROOFBOUNTY_CONTRACT_ADDRESS` | The deployed contract address | `0x330Ac647fb4001d557B1De3692c454142e440079` |
...
| `PROOFBOUNTY_CONTRACT_ADDRESS` | Contract to index | No (but treated as a secret via `fly secrets` for convenience — no harm either way) | `0x330Ac647fb4001d557B1De3692c454142e440079` |
